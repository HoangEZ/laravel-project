                           ...
                           <div class="iso-box-wrapper col4-iso-box">
                              ...
                              <div class="iso-box photoshop branding col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img1.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="/entry"><i class="fa fa-link"></i></a>
                                                <h2>Project One</h2>
                                             </div>
                                       </div>
                                 </div>
                              ...
                              <div class="iso-box graphic template col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img2.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="/entry"><i class="fa fa-link"></i></a>
                                                <h2>Project Two</h2>
                              ...
                              <div class="iso-box template graphic col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img3.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="/entry"><i class="fa fa-link"></i></a>
                                                <h2>Project Three</h2>
                              ...
                              <div class="iso-box graphic template col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img4.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="/entry"><i class="fa fa-link"></i></a>
                                                <h2>Project Four</h2>
                              ...
                              <div class="iso-box photoshop branding col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img5.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="/entry"><i class="fa fa-link"></i></a>
                                                <h2>Project Five</h2>
                              ...
                              <div class="iso-box graphic branding col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="{{url('/public/images/portfolio-img6.jpg')}}" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
